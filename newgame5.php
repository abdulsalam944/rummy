            ...
            <div class="container">
                ...
                <div class="result_sec">
                    ...
                    <div class="player_1 current-player" data-user="">
                            <div class="card_submit_time ">25</div>
...
<script>
            ...
            $(document).ready(function(){
             ...
             //Maps an event to the window closing event
                // window.onbeforeunload = function(e) { /* call the leave table function */
         ...
         var maxParticipantsAllowed;  
          ...
          var rejoinGameCounter = 10;


          var rejoinGameStartHandler = function(callback){
                
                this.interval = setInterval(function(){
                 
                 if(rejoinGameCounter <= 0){
                   ...
                   $('.popup_rejoin .popup_counter p').text('Next game will start in '+rejoinGameCounter+' seconds');
                   rejoinGameCounter--;
     ...
     /*     return JSON.stringify({
      ...
      /* Wrong val display function force called without points update */
              ...
              function wrongValidationDisplayProcess2ForceCall(roomIdCookie, gameType, sessionKeyCookie, chipsToTablePRCookie, currentBalanceCookie, minBuyingPRCookie, betValueCookie, status){
  ...
  /* Wrong Meld Validation Display */
        ...
        function wrongValidationDisplayProcess(points, roomIdCookie, gameType, sessionKeyCookie, chipsToTablePRCookie, currentBalanceCookie, minBuyingPRCookie, betValueCookie, event){
         ...
         function successfulMelding(roomIdCookie, gameType, sessionKeyCookie, chipsToTablePRCookie, currentBalanceCookie, minBuyingPRCookie, betValueCookie, status){
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(result){
                                                 ...
                                                 if($.trim(result) == "ok"){
                                                    ...
                                                    var ajxData010011 = {'action': 'connection-id-update', roomId: roomId, connectionId: connection.userid, player: userId, sessionKey: theUniqueId};
             ...
             $('.popup_bg').delegate('.joinGameBtn', 'click', function(){
              ...
              function rejoinRequestPR(){
                ...
                $('.popup_rejoin #rejoinBtn').click(function(){
                  ...
                  // var rejoinGameHandle = new rejoinGameStartHandler();
                  // clearInterval(rejoinGameHandle.interval);
                  // rejoinGameCounter = 10;
                  ...
                  $('.popup_rejoin .popup_counter p').text('');
                   ...
                   // $.cookie("rejoinScore", parseFloat( Math.round(result['highestPoint']) + 1) );
                    ...
                    var signalRejoinAgain = {type: 'update-players-playing-rejoin', message: 'updating players playing on rejoining', playersPlayingTemp: playersPlayingTemp, player: userId, playerName: name, rejoinScore: rejoinScore};
                    ...
                    var ajxData245 = {'action': 'get-throw-card', roomId: roomIdCookie, sessionKey: sessionKeyCookie};
                           ...
                           $.ajax({
                             ...
                             $('.current-player .toss .playingCards').html("");
                              ...
                              $('.current-player[data-user="'+player.id+'"] .player_name #score').text(rejoinScore);
        ...
        connection.onleave = function(e) {
           ...
           if(dataReceived.type == "leave-table"){
                                       ...
                                       for(var i = 0; i < playersPlaying.length; i++){
                                          ...
                                          console.log("doing for ", playersPlaying[i]);
                                             ...
                                             /* Get user names  */
                                              ...
                                              var ajxData853 = { 'action': 'update-player-melded', roomId: roomIdCookie, player: playersPlaying[i], sessionKey: sessionKeyCookie};
                                                          ...
                                                          $.ajax({
                                                            ...
                                                            success: function(results){
                                                               ...
                                                               if( $('.result_sec tbody[id="score_reports"] tr[data-user="'+player.id+'"] td[id="cards"]' .playingCards).length == 0 ){
                                                                  ...
                                                                  if(statusFlag != 'drop' && statusFlag != 'middle drop'){
                                                                      ...
                                                                      $.ajax({
                                                                        ...
                                                                        success: function(results){
                                                                            ...
                                                                            if( $('.result_sec tbody[id="score_reports"] tr[data-user="'+player.id+'"] td[id="cards"]' .playingCards).length == 0 ){
                                                                                 ...
                                                                                 if(scoreboardStatus != 'drop' && statusFlag != 'middle drop'){
                                                        ...
                                                        success: function(count){
                                                           ...
                                                           if(parseInt(playersPlaying.length) - parseInt(count) != 1){
                                                               console.log("everyone has not melded yet!");
                                                                ...
                                                                wrongValidationDisplayProcess2ForceCall(roomIdCookie, gameTypeCookie, sessionKeyCookie, chipsToTablePRCookie, currentBalanceCookie, minBuyingPRCookie, betValueCookie, 'lost');
                                    ...
                                    if(parseInt(userId) === parseInt(winner)){
                                       ...
                                       setTimeout(function(){
                                        ...
                                        var newChipsToTablePRCookie = parseFloat(chipsToTablePRCookie) + parseFloat(winningAmount);
                                           ...
                                           // $.cookie("chipsToTablePR", 100.54);
                                           // $.cookie("currentBalancePR", 400.45);
                                           // $.cookie("betValue", 400.45);
                        ...
                        $.ajax({
                            ...
                            success: function(player){
                                ...
                                if(parseInt(player) == parseInt(userId)){
                                 ...
                                 var signalLeaveTable = {type: 'leave-table', user: userId, nextPlayer: nextPlayer, message: "someone left...... message.."}
