		...
		$totalMelders = '';
			...
			// row exists
				...
				if($wrongMelders != ""){
					...
					$sqlPlayerUpdate = mysql_query("UPDATE game_running SET wrong_melders = '".$totalMelders."' WHERE game_id = '".$roomId."' AND session_key = '".$sessionKey."' LIMIT 1");




				}else{
					$sqlPlayerUpdate = mysql_query("UPDATE game_running SET wrong_melders = ".$playerId." WHERE game_id = '".$roomId."' AND session_key = '".$sessionKey."' LIMIT 1");
				}
