        ...
        if(counterM <= 0){
            ...
            var ajxData850 = { 'action': 'update-melded-count', roomId: roomIdCookie, sessionKey: sessionKeyCookie};
             ...
             /* update wrong melders list */
              ...
              var ajxData852ss = { 'action': 'update-wrong-melders', roomId: roomIdCookie, player: _userId, sessionKey: sessionKeyCookie};
           ...
           /* update player has melded */
              ...
              var ajxData853 = { 'action': 'update-player-melded', roomId: roomIdCookie, player: _userId, sessionKey: sessionKeyCookie};
             ...
             $.ajax({
              ...
              if($.trim(event) == "wrongshow"){
                ...
                var ajxDataLost = { 'action': 'update-player-scoreboard-status', roomId: roomIdCookie, player: _userId, sessionKey: sessionKeyCookie, status:statusScoreboard};
            ...
            $.ajax({
                ...
                success: function(totalPoints){
                    ...
                    if(gameType != 'score'){
                        $('.current-player[data-user="'+_userId+'"] .player_name #score').text(parseInt(totalPoints));
                    }
                    ...
                    console.log('Cards in hand ',cardsInHand);
                       if(gameType == "101"){ 
                            ...
                            if(totalPoints >= 101){
                                 ...
                                 var ajxData704 = {'action': 'update-my-status', roomId: roomIdCookie, player: _userId, sessionKey: sessionKeyCookie};
                            ...
                            if(removeCardFromGroups(_userId, playersPlayingTemp)){
                                console.log("player removed ", playersPlayingTemp);
                            }
            ...
            success: function(totalPoints){
                ...
                console.log(" total points received ", totalPoints);
                            ...
                            $.ajax({
                                ...
                                success: function(player){
                                    ...
                                    if(gameType != "score"){
                                        ...
                                        var ajxData704 = {'action': 'get-scoreboard', roomId: roomIdCookie, player: _userId, sessionKey: sessionKeyCookie};
                                          ...
                                          $.ajax({
                                            ...
                                            success: function(results){
                                               ...
                                               $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="result"]').text(scoreboardStatus);   


                                              $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="score"]').text(Math.round(points));
                                            
                                                $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="total_score"]').text(Math.round(totalPts));

                                                if( $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="cards"]' .playingCards).length == 0 ){

                                                $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="cards"]').html(showCardsInScoreboard(_userId, roomIdCookie, sessionKeyCookie));
                                        ...
                                        var ajxData704 = {'action': 'get-scoreboard', roomId: roomIdCookie, player: _userId, sessionKey: sessionKeyCookie};
                                          ...
                                          $.ajax({
                                            ...
                                            success: function(results){
                                                ...
                                                $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="count"]').text(points);
                                            
                                                $('.result_sec tbody[id="score_reports"] tr[data-user="'+_userId+'"] td[id="total_chips"]').text('-'+totalPts);
                       ...
                       if(gameType == "101"){ 
                        ...
                        var signal1011 = {room:roomName, type: 'get-scoreboard-six-players', message: 'get all your scoreboards', firstMelder: _userId, status:status};
