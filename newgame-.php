...
<!--                <div class="game_bottom"> 
   ...
   <div class="popup_leave_second">
    ...
    <script>
        ...
        //  var reconnectCounter = 30;   


        //  function checkReconnectionfac(){

        //     var self = this;

        //      this.checkReconnection = setInterval(function(){

                 

        //         if(reconnectCounter == 0){
        //              $('.connectionOverlay3').show();
        //              clearInterval(self.checkReconnection);
         ...
         connection.ondisconnected = function(event) {
           // if(connection.isInitiator) return; // skip below code for Host
             ...
             var remoteUser = connection.peers[event.userid];
              ...
              console.log("DISCONNECTION User newww : ", remoteUser.userid);

              var ajaxGetConnectionId = {'action': 'get-user-id', roomId: roomIdCookie, sessionKey: sessionKeyCookie, playerId: remoteUser.userid};
